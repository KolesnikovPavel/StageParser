...
namespace DataStreamProcess.Processing.Units.CommentParsers
{
    public class CommentStageParser
    {
        ...
        public void PerformAllTypeMatcher()
        {
            ...
            MatchCollection test = Regex.Matches(comment,@"");
            ...
            //1-ий этаж, 2-ой этаж
            MatchCollection st1 = Regex.Matches(comment, @"(?!м).\s(\d{1,2})[ \s-ыйои–]+этаж[ \s-!\/.,;]+?");
            ...
            MatchCollection st2 = Regex.Matches(comment, @"этаж[ –:\-\s]+([\d]+[ \s-ыйои–]*|[первый]{4,}|[второй]{4,}|[третий]{4,}|[подземный]{4,}|[цокольный]{4,}|[четвертый]{4,}|[пятый]{4,}|[шестой]{4,}|[седьмой]{4,}|[восьмой]{4,}|[девятый]{4,}|[десятый]{4,})[ :.!,\s;]+?");
