...
namespace DataStreamProcess.Processing.Units.CommentParsers
{
    public class CommentStageParser
    {
        ...
        public void PerformAllTypeMatcher()
        {
            ...
            //1-ий этаж, 2-ой этаж
            MatchCollection st1 = Regex.Matches(comment, @"(^\d{1,3}|\s\d{1,3})(?!\n)[ \s-ыйои–]+этаж[ \s\/\-!.,:;]+?");
            ...
            MatchCollection st2 = Regex.Matches(comment, @"этаж[ –:\-\s]+([\d]+[ \s-ыйои–]*|[первый]{4,}|[второй]{4,}|[третий]{4,}|[подземный]{4,}|[цокольный]{4,}|[четвертый]{4,}|[пятый]{4,}|[шестой]{4,}|[седьмой]{4,}|[восьмой]{4,}|[девятый]{4,}|[десятый]{4,})[ :.!\s;,]+?(?!м|к).");
            ...
            MatchCollection st5 = Regex.Matches(comment, @"([первый]{4,}|[второй]{4,}|[третий]{4,}|[подземный]{4,}|[цокольный]{5,}|[цокольное]{6,}|[четвертый]{4,}|[пятый]{4,}|[шестой]{4,}|[седьмой]{4,}|[восьмой]{4,}|[девятый]{4,}|[десятый]{4,})[ .!,\s]+?(этаж|этаже)[ !;.,\-:\s]+");
            // in instead of on
            ...
            MatchCollection st11 = Regex.Matches(comment, @"([первом]{4,}|[втором]{4,}|[третьем]{4,}|[подземном]{4,}|[цокольном]{5,}|[четвертом]{4,}|[пятом]{4,}|[шестом]{4,}|[седьмом]{4,}|[восьмом]{4,}|[девятом]{4,}|[десятом]{4,})[, ли]+([первом]{4,}|[втором]{4,}|[третьем]{4,}|[подземном]{4,}|[цокольном]{4,}|[четвертом]{4,}|[пятом]{4,}|[шестом]{4,}|[седьмом]{4,}|[восьмом]{4,}|[девятом]{4,}|[десятом]{4,})[, ]+этаже");

            MatchCollection st12 = Regex.Matches(comment, @"\s[\d]+[, \d\-го]+этажа");
            ...
            MatchCollection st18 = Regex.Matches(comment, @"(\d+[ \s-ыйои–]*)этаж[ \s-!.,;]+\d+[ \s-тих]*этаж");
            ...
            this.FindStringStage(st16, elementsToFind, this._digitsArr2, this._digitInt2);
